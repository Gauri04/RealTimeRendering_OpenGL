...
@implementation GLESView
{
    ...
    GLuint grgVaoRectangle;
    GLuint grgVbo_position_rectangle;
...
-(void)initialize
{
    ...
    glGenVertexArrays(1, &grgVaoRectangle);
    glBindVertexArray(grgVaoRectangle);

    glGenBuffers(1, &grgVbo_position_rectangle);
    glBindBuffer(GL_ARRAY_BUFFER, grgVbo_position_rectangle);
    glBufferData(GL_ARRAY_BUFFER, sizeof(grrectangleVerts), grrectangleVerts, GL_STATIC_DRAW);
...
-(void)uninitialize
{
    ...
    if (grgVbo_position_rectangle)
    {
        glDeleteBuffers(1, &grgVbo_position_rectangle);
        grgVbo_position_rectangle = 0;
    }
    if (grgVaoRectangle)
    {
        glDeleteVertexArrays(1, &grgVaoRectangle);
        grgVaoRectangle = 0;
    }
