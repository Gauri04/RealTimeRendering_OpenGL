...
@implementation GLESView
{
    ...
    GLfloat grtriangleVerts[9];
    GLfloat grsquareVerts[12];

    GLfloat grcircleVerts[1258];
    double grs;
    double PI;
    double grlength1, grlength2, grlength3;
    double grradius;
    double grincenterX, grincenterY;
    double grsqrt;
...
-(void)initialize
{
    ...
    // initialize vars
    PI = 3.14159655359f;
    grtriangleVerts[0] = 0.0f;
    grtriangleVerts[1] = 0.5f;
    grtriangleVerts[2] = 0.0f;
    grtriangleVerts[3] = -0.5f;
    grtriangleVerts[4] = -0.5f;
    grtriangleVerts[5] = 0.0f;
    grtriangleVerts[6] = 0.5f;
    grtriangleVerts[7] = -0.5f;
    grtriangleVerts[0] = 0.0f;
    grsquareVerts[0] = 0.86f;
    grsquareVerts[1] = 0.5f;
    grsquareVerts[2] = 0.0f;
    grsquareVerts[3] = -0.86f;
    grsquareVerts[4] = 0.5f;
    grsquareVerts[5] = 0.0f;
    grsquareVerts[6] = -0.86f;
    grsquareVerts[7] = -0.5f;
    grsquareVerts[8] = 0.0f;
    grsquareVerts[9] = 0.86f;
    grsquareVerts[10] = -0.5f;
    grsquareVerts[11] = 0.0f;
