...
-(void)initialize
{
    ...
    grkeyPress = 1;
    grsmiley_texture = [self loadTextureFromBMP:@"Smiley" :@".bmp"];
    if(grsmiley_texture == 0)
    {
...
-(void)drawView:(id)sender
{
    ...
    glBindTexture(GL_TEXTURE_2D, grsmiley_texture);
...
-(void)uninitialize
{
    ...
    if (grsmiley_texture)
    {
        glDeleteTextures(1, &grsmiley_texture);
        grsmiley_texture = 0;
    }
