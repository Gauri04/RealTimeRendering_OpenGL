...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SIZE:
		...
		{
			grgWidth = LOWORD(lParam);
			grgHeight = HIWORD(lParam);
...
HRESULT Initialize()
{
	...
	// texture
	//hr = LoadD3DTexture(L"Smiley.bmp", &gpID3D11ShaderResourceView_TextureRectangle);
	if (FAILED(hr))
	{
		fopen_s(&grgpFile, logFileName, "a+");
...
HRESULT LoadD3DTexture(const wchar_t* textureFileName, ID3D11ShaderResourceView** ppID3D11ShaderResourceView)
{
	...
	gpIDXGISwapChain->ResizeBuffers(1, grgWidth, grgHeight, DXGI_FORMAT_R8G8B8A8_UNORM, 0);
	gpIDXGISwapChain->GetBuffer(0, __uuidof(ID3D11Texture2D), (LPVOID*)&pID3D11Texture2D_Position);
	hr = gpID3D11Device->CreateRenderTargetView(pID3D11Texture2D_Position, NULL, &pID3D11RTV);
	...
	//hr = DirectX::CreateWICTextureFromMemory(gpID3D11Device, gpID3D11DeviceContext, grgCheckImage, CHECK_IMAGE_HEIGHT * CHECK_IMAGE_HEIGHT * 4,NULL, ppID3D11ShaderResourceView);
	//hr = DirectX::CreateWICTextureFromMemory()
	pID3D11Texture2D_Position->Release();
	pID3D11Texture2D_Position = NULL;
...
void Display(void)
{
	...
	if (grgKeyPressed == 1)
	{
		squareTexCoord1[0] = 0.0;
		squareTexCoord1[1] = 0.0;
		//2
		squareTexCoord1[2] = 1.0;
		squareTexCoord1[3] = 0.0;
		//3
		squareTexCoord1[4] = 0.0;
		squareTexCoord1[5] = 1.0;
		//4
		squareTexCoord1[6] = 0.0;
		squareTexCoord1[7] = 1.0;
		//5
		squareTexCoord1[8] = 1.0;
		squareTexCoord1[9] = 0.0;
		//6
		squareTexCoord1[10] = 1.0;
		squareTexCoord1[11] = 1.0;
	}

	else if (grgKeyPressed == 2)
	{
		squareTexCoord1[0] = 0.0;
		squareTexCoord1[1] = 0.0;
		//2
		squareTexCoord1[2] = 0.5;
		squareTexCoord1[3] = 0.0;
		//3
		squareTexCoord1[4] = 0.0;
		squareTexCoord1[5] = 0.5;
		//4
		squareTexCoord1[6] = 0.0;
		squareTexCoord1[7] = 0.5;
		//5
		squareTexCoord1[8] = 0.5;
		squareTexCoord1[9] = 0.0;
		//6
		squareTexCoord1[10] = 0.5;
		squareTexCoord1[11] = 0.5;
	}

	else if (grgKeyPressed == 3)
	{
		squareTexCoord1[0] = 0.0;
		squareTexCoord1[1] = 0.0;
		//2
		squareTexCoord1[2] = 2.0;
		squareTexCoord1[3] = 0.0;
		//3
		squareTexCoord1[4] = 0.0;
		squareTexCoord1[5] = 2.0;
		//4
		squareTexCoord1[6] = 0.0;
		squareTexCoord1[7] = 2.0;
		//5
		squareTexCoord1[8] = 2.0;
		squareTexCoord1[9] = 0.0;
		//6
		squareTexCoord1[10] = 2.0;
		squareTexCoord1[11] = 2.0;
	}

	else if (grgKeyPressed == 4)
	{
		squareTexCoord1[0] = 0.5;
		squareTexCoord1[1] = 0.5;
		squareTexCoord1[2] = 0.5;
		squareTexCoord1[3] = 0.5;
		squareTexCoord1[4] = 0.5;
		squareTexCoord1[5] = 0.5;
		squareTexCoord1[6] = 0.5;
		squareTexCoord1[7] = 0.5;
		squareTexCoord1[8] = 0.5;
		squareTexCoord1[9] = 0.5;
		squareTexCoord1[10] = 0.5;
		squareTexCoord1[11] = 0.5;
	}

	gpID3D11DeviceContext->Map(gpiD3D11Buffer_VertexBuffer_TexCoordRectangle, 0, D3D11_MAP_WRITE_DISCARD, 0, &gMappedSubResource_Texcoords);
	memcpy(gMappedSubResource_Texcoords.pData, squareTexCoord1, sizeof(squareTexCoord1));
	gpID3D11DeviceContext->Unmap(gpiD3D11Buffer_VertexBuffer_TexCoordRectangle, 0);
