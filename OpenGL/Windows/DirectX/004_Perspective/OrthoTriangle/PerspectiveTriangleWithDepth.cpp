...
HRESULT Initialize()
{
	...
	ZeroMemory(&d3d11InputElementDesc, sizeof(d3d11InputElementDesc));
	...
	float vertices[] =												// It follows CW winding order (ClockWise) not CCW like OGL or directx is left handed while ogl is right handed
	{
		0.0f, 1.0f, 0.0f,
		1.0f, -1.0f, 0.0f,
		-1.0f, -1.0f, 0.0f
