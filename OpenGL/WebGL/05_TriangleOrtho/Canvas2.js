...
var rg_requestAnimationFrame = window.requestAnimationFrame || 
...
var grvbo;
var grmvpUniform;
var grorthographicProjectionMatrix;

var rg_cancelAnimationFrame = window.cancelAnimationFrame || 
...
function init()
{
    ...
    grorthographicProjectionMatrix = mat4.create();
    // blue color
...
function resize()
{
    ...
    {
        mat4.ortho(grorthographicProjectionMatrix, -100.0, 100.0, (-100.0 * (canvas.height / canvas.width)), (100 * (canvas.width / canvas.height)),
            -100.0, 100.0);
    }
    else
    {
...
function draw()
{
    ...
    mat4.multiply(grmodelViewProjectionMatrix, grorthographicProjectionMatrix, grmodelViewMatrix);
