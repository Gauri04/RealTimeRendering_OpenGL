...
function Mesh()
{
    ...
    this.prepareToDraw=function()
    {
        ...
        gl.vertexAttribPointer(WebGLMacros.GR_ATTRIBUTE_POSITION,
                               3,
                               gl.FLOAT,
                               false,0,0);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      norms,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(WebGLMacros.GR_ATTRIBUTE_NORMAL,
                               3,
                               gl.FLOAT,
                               false,0,0);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      texCoords,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(WebGLMacros.GR_ATTRIBUTE_TEXTURE,
