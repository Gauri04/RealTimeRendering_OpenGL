...
var grbXKeyPressed = false;
var grbYKeyPressed = false;
var grbZKeyPressed = false;
var grlightAmbient1 = new Float32Array([0.0, 0.0, 0.0]);
var grlightDiffuse1 = new Float32Array([1.0, 0.0, 0.0]);
var grlightSpecular1 = new Float32Array([1.0, 0.0, 0.0]);
var grlightPosition1 = new Float32Array([0.0, 0.0, 0.0, 1.0]);
var grlightAmbient2 = new Float32Array([0.0, 0.0, 0.0]);
var grlightDiffuse2 = new Float32Array([0.0, 1.0, 0.0]);
var grlightSpecular2 = new Float32Array([0.0, 1.0, 0.0]);
var grlightPosition2 = new Float32Array([0.0, 0.0, 0.0, 1.0]);
var grlightAmbient3 = new Float32Array([0.0, 0.0, 0.0]);
var grlightDiffuse3 = new Float32Array([0.0, 0.0, 1.0]);
var grlightSpecular3 = new Float32Array([0.0, 0.0, 1.0]);
var grlightPosition3 = new Float32Array([0.0, 0.0, 0.0, 1.0]);
...
function keyDown(event)
{
   switch(event.keyCode)
   {
       case 70 :
        ...
        case 88 :                       // x
            grbXKeyPressed = !grbXKeyPressed;
            break;

        case 89 :                       //y
            grbYKeyPressed = !grbYKeyPressed;
            break;

        case 90 :                       // z
            grbZKeyPressed = !grbZKeyPressed;
            break;
...
function init()
{
    ...
    grldUniformPV1 = gl.getUniformLocation(grshaderProgramObjectPV, "u_ld[0]");
    grlaUniformPV1 = gl.getUniformLocation(grshaderProgramObjectPV, "u_la[0]");
    grlsUniformPV1 = gl.getUniformLocation(grshaderProgramObjectPV, "u_ls[0]");
    grldUniformPV2 = gl.getUniformLocation(grshaderProgramObjectPV, "u_ld[1]");
    grlaUniformPV2 = gl.getUniformLocation(grshaderProgramObjectPV, "u_la[1]");
    grlsUniformPV2 = gl.getUniformLocation(grshaderProgramObjectPV, "u_ls[1]");
    grldUniformPV3 = gl.getUniformLocation(grshaderProgramObjectPV, "u_ld[2]");
    grlaUniformPV3 = gl.getUniformLocation(grshaderProgramObjectPV, "u_la[2]");
    grlsUniformPV3 = gl.getUniformLocation(grshaderProgramObjectPV, "u_ls[2]");

    grlightPositionUniformPV1 = gl.getUniformLocation(grshaderProgramObjectPV, "u_light_position[0]");
    grlightPositionUniformPV2 = gl.getUniformLocation(grshaderProgramObjectPV, "u_light_position[1]");
    grlightPositionUniformPV3 = gl.getUniformLocation(grshaderProgramObjectPV, "u_light_position[2]");
    ...
    grldUniformPF1 = gl.getUniformLocation(grshaderProgramObjectPF, "u_ld[0]");
    grlaUniformPF1 = gl.getUniformLocation(grshaderProgramObjectPF, "u_la[0]");
    grlsUniformPF1 = gl.getUniformLocation(grshaderProgramObjectPF, "u_ls[0]");
    grldUniformPF2 = gl.getUniformLocation(grshaderProgramObjectPF, "u_ld[1]");
    grlaUniformPF2 = gl.getUniformLocation(grshaderProgramObjectPF, "u_la[1]");
    grlsUniformPF2 = gl.getUniformLocation(grshaderProgramObjectPF, "u_ls[1]");
    grldUniformPF3 = gl.getUniformLocation(grshaderProgramObjectPF, "u_ld[2]");
    grlaUniformPF3 = gl.getUniformLocation(grshaderProgramObjectPF, "u_la[2]");
    grlsUniformPF3 = gl.getUniformLocation(grshaderProgramObjectPF, "u_ls[2]");

    grlightPositionUniformPF1 = gl.getUniformLocation(grshaderProgramObjectPF, "u_light_position[0]");
    grlightPositionUniformPF2 = gl.getUniformLocation(grshaderProgramObjectPF, "u_light_position[1]");
    grlightPositionUniformPF3 = gl.getUniformLocation(grshaderProgramObjectPF, "u_light_position[2]");
...
function draw()
{
    ...
    if(grbIsVertexLighting == true)
    {
        ...
        if(grbIsLight)
        {
            ...
            if(grbXKeyPressed)
            {
                grlightPosition1 = new Float32Array([0.0, 7.5 * Math.sin(grfangle), 7.5 * Math.cos(grfangle), 1.0]);
            }
            if(grbYKeyPressed)
            {
                grlightPosition2 = new Float32Array([7.5 * Math.sin(grfangle), 0.0,  7.5 * Math.cos(grfangle), 1.0]);
            }
            if(grbZKeyPressed)
            {
                grlightPosition3 = new Float32Array([7.0 * Math.sin(grfangle), 7.0 * Math.cos(grfangle), 0.0,  1.0]);
            }

            gl.uniform3fv(grldUniformPV1, grlightDiffuse1);
            gl.uniform3fv(grlaUniformPV1, grlightAmbient1);
            gl.uniform3fv(grlsUniformPV1, grlightSpecular1);
            gl.uniform4fv(grlightPositionUniformPV1, grlightPosition1);
            gl.uniform3fv(grldUniformPV2, grlightDiffuse2);
            gl.uniform3fv(grlaUniformPV2, grlightAmbient2);
            gl.uniform3fv(grlsUniformPV2, grlightSpecular2);
            gl.uniform4fv(grlightPositionUniformPV2, grlightPosition2);
            gl.uniform3fv(grldUniformPV3, grlightDiffuse3);
            gl.uniform3fv(grlaUniformPV3, grlightAmbient3);
            gl.uniform3fv(grlsUniformPV3, grlightSpecular3);
            gl.uniform4fv(grlightPositionUniformPV3, grlightPosition3);
        }
        else
        {
    ...
    else
    {
        ...
        if(grbIsLight)
        {
            ...
            if(grbXKeyPressed)
            {
                grlightPosition1 = new Float32Array([0.0, 5.5 * Math.sin(grfangle), 5.5 * Math.cos(grfangle), 1.0]);
            }
            if(grbYKeyPressed)
            {
                grlightPosition2 = new Float32Array([4.5 * Math.sin(grfangle), 0.0,  4.5 * Math.cos(grfangle), 1.0]);
            }
            if(grbZKeyPressed)
            {
                grlightPosition3 = new Float32Array([6.5 * Math.sin(grfangle), 6.5 * Math.cos(grfangle), 0.0,  1.0]);
            }

            gl.uniform3fv(grldUniformPF1, grlightDiffuse1);
            gl.uniform3fv(grlaUniformPF1, grlightAmbient1);
            gl.uniform3fv(grlsUniformPF1, grlightSpecular1);
            gl.uniform4fv(grlightPositionUniformPF1, grlightPosition1);
            gl.uniform3fv(grldUniformPF2, grlightDiffuse2);
            gl.uniform3fv(grlaUniformPF2, grlightAmbient2);
            gl.uniform3fv(grlsUniformPF2, grlightSpecular2);
            gl.uniform4fv(grlightPositionUniformPF2, grlightPosition2);
            gl.uniform3fv(grldUniformPF3, grlightDiffuse3);
            gl.uniform3fv(grlaUniformPF3, grlightAmbient3);
            gl.uniform3fv(grlsUniformPF3, grlightSpecular3);
            gl.uniform4fv(grlightPositionUniformPF3, grlightPosition3);
        }
        else
        {
...
{
    // code
    if(grbXKeyPressed || grbYKeyPressed || grbZKeyPressed)
    {
