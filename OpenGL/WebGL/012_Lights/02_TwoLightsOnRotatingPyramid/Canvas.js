...
var grlightPosition1 = new Float32Array([-2.0, 0.0, 0.0, 1.0]);
var grlightAmbient2 = new Float32Array([0.0, 0.0, 0.0]);
var grlightDiffuse2 = new Float32Array([0.0, 0.0, 1.0]);
var grlightSpecular2 = new Float32Array([0.0, 0.0, 1.0]);
var grlightPosition2 = new Float32Array([2.0, 0.0, 0.0, 1.0]); 
...
function init()
{
    ...
    var grpyramidNormals = new Float32Array(
        [
    ...
    grvboPyramidNormal = gl.createBuffer();
    gl.bindBuffer(gl.ARRAY_BUFFER, grvboPyramidNormal);
    gl.bufferData(gl.ARRAY_BUFFER, grpyramidNormals, gl.STATIC_DRAW);
...
function uninitialize()
{
    ...
    {
        gl.deleteBuffer(grvboPyramidNormal);
        grvboPyramidNormal = null;
    }
